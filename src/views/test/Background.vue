...
export default {
  ...
  methods: {
    // 创建小心心
    // createLoves(event) {
    //   console.log("createLoves function is running")
    //   let x = 0;
    //   let y = 0;
    ...
    createBubble(){
      ...
      for (var i = 0; i < 11; i++) {
        ...
        // if(i === 0) {
        //   bubble.left = 'left::50px;'
        //   bubble.width = 'width:80px;'
        //   bubble.height = 'width:80px;'
        // }else if(i === 1) {
        //   bubble.left = 'left::250px;'
        //   bubble.width = 'width:80px;'
        //   bubble.height = 'width:80px;'
        // }

        // if(i === 3) {
        //   bubble.width = 'width:220px;'
        // }
